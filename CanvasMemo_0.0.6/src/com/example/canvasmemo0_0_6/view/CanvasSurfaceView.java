...
// タッチイベント用
	...
	/*
	 * @param aLine セットする aLine
	 */
	public void setaLine(Line aLine) {
		this.aLine = aLine;
	}

	/**
	 * @param drawingThread セットする drawingThread
	 */
	public void setDrawingThread(Thread drawingThread) {
...
//		SurfaceViewに描画
	...
	public void setNewLine(int sx, int sy) {
		aLine = new Line();
		aLine.addPoint(new Point(sx, sy));
	}

	public void setNewLine(Point sPoint) {
		aLine = new Line();
		aLine.addPoint(sPoint);
	}

	public void addNewPointToLine(int x, int y) {
		aLine.addPoint(new Point(x, y));
		drawingThread = new Thread(this);
		drawingThread.start();
	}

	public void addNewPointToLine(Point cPoint) {
		aLine.addPoint(cPoint);
		drawingThread = new Thread(this);
		drawingThread.start();
	}
